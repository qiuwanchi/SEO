...
<div id="case">
	...
	<div class="container main">
		<div class="position">当前位置：<a href="index.html">首页</a>|<a href="case.html">公司产品</a>|<span>产品详情</span></div>
...
<p>展厅智能中控系统能够更加智能化地控制展厅多媒体，以此来为用户展示更加智慧化的内容，不仅能够丰富用户的体验，还能加深用户对展厅的印象，扩大展厅的宣传范围，让更多人认识到展厅所向用户传递的内容。
</p>
           <div class="getPrice"><a href="javascript:;">获取详细报价</a></div>
		    ...
		    <div class="detail2 clearfix">
		    	<div class="detail2_text">
		    		<h2>展厅智能中控系统特点</h2>
		    		<span>Features of intelligent central control system in exhibition hall</span>
		    	</div>
		    	<ul class="detail2_ul clearfix">
		    		<li class="clearfix">
		    			<a href="javascript:;">
		    				<img src="images/img_good1.jpg">
		    			</a>
		    			<span><img src="images/arrow.png"></span>
		    		</li>
		    		<li class="clearfix">
		    			<a href="javascript:;">
		    				<img src="images/img_good2.jpg">
		    			</a>
		    			<span><img src="images/arrow.png"></span>
		    		</li>
		    		<li class="clearfix">
  ...
  <div class="layui-tab layui-tab-brief clearfix " lay-filter="docDemoTabBrief">
    ...
    <div class="layui-tab-item clearfix">
        ...
        <div class="detail5">
            ...
            <div style="width: 100%; text-align: center;"><button type="submit" class="layui-btn" lay-submit="">立即获取</button></div>
            <form>
        	</div>
        </div>
		    <div class="detail6">

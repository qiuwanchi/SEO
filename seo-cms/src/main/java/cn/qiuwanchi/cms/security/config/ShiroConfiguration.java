package cn.qiuwanchi.cms.security.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import cn.qiuwanchi.cms.security.cache.ShiroRedisCacheManager;
import cn.qiuwanchi.cms.security.token.DreamerCMSRealm;
import cn.qiuwanchi.cms.utils.CipherKeyUtils;
...
public class ShiroConfiguration {
	 ...
	 * @return
	 */
	@Bean("simpleSessionIdCookie")
	public SimpleCookie sessionIdCookie() {
		SimpleCookie simpleCookie = new SimpleCookie("seo-cms-s");
	...
	public SimpleCookie rememberMeCookie() {
		SimpleCookie rememberMeCookie = new SimpleCookie("seo-cms-r");
